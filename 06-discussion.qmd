...
Although, the use of liquids for decontamination may be problematic when there
...
Not a great feature when looking for
...
are able to
detect these compounds directly, .i.e., without the step of derivatization
...
for all purposes. Horses for courses. There are likely better sites to sample for
...
also have the advantage over DNA in that proteins seem to preserve for longer.
...
incorporation events. Since we can't yet access information about the age of
...
<!-- working more openly-->
Contributing to the knowledge of dental calculus
...
of materials to conduct large-scale analyses [@yatesOralMicrobiome2021].
...
Many of these initiatives fall on researchers early in their careers out of a
need for more resources or sheer enthusiasm for what they do. Unfortunately,
there are still very few incentives for organising these resources and practicing
...
scrutinizing what we know about dental calculus, what we think we know, and what
we need to know.
...
calculus analytical lifecycle. Formation and growth. Exposure to dietary and
non-dietary materials. Burial with subsequent degradation of original materials
and the colonisation of materials and molecules from the burial environment.
Decontamination and extraction of materials trapped within the calculus.
Interpretation of the results from applied analytical methods.
With the help of co-authors, the model dental calculus was examined to ensure
that the bacterial and mineral
compositions were sufficient to mimic an oral environment and closely resembles
