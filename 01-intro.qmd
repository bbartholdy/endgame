...
source of diet than teeth or other bones, since the turnover is much quicker in
calculus than bone.
...
signal. Further, enamel stops forming after the crown of the last tooth has
...
In the past, some researchers would consider calculus a nuisance because it
...
A simple three-stage archaeology-specific scoring method was developed
...
survive for millenea, allowing us to look at the diets of early humans and other
hominins
...
blue pigment was detected in the dental calculus of a Medieval German woman.
This blue pigment happened to originate from lapis lazuli, an exotic stone used
to write manuscripts [@radiniMedievalWomen2019]. Nicotine was detected in dental
calculus of pre-colonisation individuals from California using UPLC-MS/MS,
showing direct consumption of tobacco and providing more
detailed insights on the demographics of consumption in a way that no other
...
are a little cliché and tedious, but often necessary. Since oral health is a
