...
as calculus is a branch of mathematics. If you see the
...
within a chapter on dental diseases [e.g. @robertsDentalDisease2007; @waldronPalaeopathology2020]. Dental caries, calculus' more famous sibling, will
...
there is certainly overlap in some areas (Figure \@ref(fig:plot-and-wordclouds)).
While clinical
...
oral bacteria that have been fossilised within.
Clinial dentistry views it as a nuisance to be removed and, ideally, prevented from
...
We need a more systematic approach to teaching and
studying dental calculus. This disseration is a contribution to a
dental-calculus-centric area of research. The main focus of my PhD was
the development, validation, and application of a mineralised oral biofilm
model. In short, can I grow calculus in the lab? Is what I'm growing actually
calculus (or at least close enough)? Can the model be used to inform archaeological
research? Using oral biofilm models to grow dental calculus is in no way a novel
...
There are many different kinds of biofilm models, which I will cover in more detail in
[Chapter 2](#background), single species and multispecies (select species).
Multispecies biofilm inoculated with whole saliva, while most difficult to control, is most
realistic model. <!--Collaboration between the bacteria facilitates growth: e.g. S. mutans, which produces lactic acid, and V. parvula, which consumes it. There are additional examples of this cooperation indicating the benefit of oral bacteria growing in densely populated community biofilms.-->
The choice of the type of oral biofilm model used in this dissertation was mainly determined
by access to facilities and finances. The multiwell culture plate is a...
and is also more realistic for the facilities and finances of most archaeological departments
and grants (it's not exactly the 'sexiest' topic).
<!-- move to chapter 2? -->
...
Chapter 2 provides some background information on oral biofilms
...
Chapter 6 is a discussion on the limitations and future potential of dental
