...
of past people and populations<!--refer to wordcloud-->. One of the ways to do this is dissolving the
...
but will be completely eclipsed by its more famous sibling, dental caries.
...
examples of how dental calculus has been used in related studies (not unlike what I have
done here).
...
remains that are trapped inside; and paleogeneticists are interested in accessing the
oral bacteria that have been fossilised inside.
...
and complicated because we are all quite unique. It's a lovely sentiment but it
...
help us interpret what we see in archaeological dental calculus?
...
We just need a more systematic approach to teaching and
studying dental calculus. This disseration is a contribution to a
dental-calculus-centric area of research, by ... on a mineralised oral biofilm
model. Using oral biofilm models to grow dental calculus is in no way a novel
