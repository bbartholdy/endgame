...
there is certainly overlap in some areas (Figure \@ref(fig:plot-and-wordclouds)B and C).
While clinical
...
the term dental calculus in the title (Figure \@ref(fig:plot-and-wordclouds)A).
...
[Chapter 2](#background). These can include a single species of bacteria, select species
determined by the researchers (defined consortium), and multiple species from some
natural source (the human mouth, for example).
Multispecies biofilm inoculated with whole saliva, while most difficult to control, is a
more realistic model. <!--Collaboration between the bacteria facilitates growth: e.g. S. mutans, which produces lactic acid, and V. parvula, which consumes it. There are additional examples of this cooperation indicating the benefit of oral bacteria growing in densely populated community biofilms.-->
We used a 24-well plate with a plastic substratum suspended from a lid. The model
was inoculated with whole saliva. The choice of the model in this dissertation was
mainly driven by facilities and financial limitations. That being said, the multiwell
culture plate is a useful model that allows us to generate many samples with the same
treatments, and is also more realistic for the facilities and finances of most archaeological
departments and grants (it's not exactly the 'sexiest' topic).
<!-- move to chapter 2? -->
